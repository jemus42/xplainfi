...
knn_numeric = KNNConditionalSampler$new(task_numeric, k = 5)
...
knn_mixed = KNNConditionalSampler$new(task_mixed, k = 5)
...
| `KNNConditionalSampler` | All | None (auto-selects distance) | Fast | CFI, simple local structure |
