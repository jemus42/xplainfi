...
vignette: >
  %\VignetteIndexEntry{Inference (Experimental)}
...
The parametric methods (`"raw"` and `"nadeau_bengio"`) differ primarily in interval width due to the variance correction, while the non-parametric `"quantile"` method can produce asymmetric intervals that better reflect the actual resampling distribution.
